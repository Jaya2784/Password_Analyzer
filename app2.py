...
try:
    generator = pipeline('text-generation', model=r"C:\Users\jayas\OneDrive\Desktop\PROJECTS_GITHUB\Password_Analyzer\models\gpt2")
except Exception as e:
    print(f"Warning: GPT-2 model not found or failed to load from 'C:\\flaskenv\\models\\gpt2'. Using basic suggestions. Error: {e}")
    generator = None

# Load trained models and scaler
try:
    rf_model = joblib.load(r"C:\Users\jayas\OneDrive\Desktop\PROJECTS_GITHUB\Password_Analyzer\random_forest_model.pkl")
    xgb_model = joblib.load(r"C:\Users\jayas\OneDrive\Desktop\PROJECTS_GITHUB\Password_Analyzer\xgboost_model.pkl")
    scaler = joblib.load(r"C:\Users\jayas\OneDrive\Desktop\PROJECTS_GITHUB\Password_Analyzer\scaler.pkl")
...
def predict_password_strength(password):
    """Predict password strength using the trained models."""
...
def analyze_password():
    ...
    predicted_strength = predict_password_strength(password)  # Predict password strength
